...
namespace Picktime.Migrations
{
    ...
    [Migration("20250620160652_Adddatabase")]
            ...
            modelBuilder.Entity("Picktime.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryName = "Bank",
                            CreatedBy = "Seed",
                            CreationDate = new DateTime(2025, 6, 20, 16, 6, 52, 129, DateTimeKind.Utc).AddTicks(2459),
            ...
            modelBuilder.Entity("Picktime.Entities.LockUpItems", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "System",
                            CreationDate = new DateTime(2025, 6, 20, 19, 6, 52, 129, DateTimeKind.Local).AddTicks(2434),
                            Discount = 0.1f,
                            IsActive = true,
                            LockUpTypeId = 1,
                            Points = 100,
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "System",
                            CreationDate = new DateTime(2025, 6, 20, 19, 6, 52, 129, DateTimeKind.Local).AddTicks(2437),
                            Discount = 0.2f,
                            IsActive = true,
                            LockUpTypeId = 1,
                            Points = 200,
                        ...
                        new
                        {
                            Id = 3,
                            CreatedBy = "System",
                            CreationDate = new DateTime(2025, 6, 20, 19, 6, 52, 129, DateTimeKind.Local).AddTicks(2438),
                            Discount = 0.3f,
                            IsActive = true,
                            LockUpTypeId = 1,
                            Points = 300,
            ...
            modelBuilder.Entity("Picktime.Entities.LockUpType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "System",
                            CreationDate = new DateTime(2025, 6, 20, 19, 6, 52, 129, DateTimeKind.Local).AddTicks(2330),
                            IsActive = true,
                            Name = "Coupon",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
            ...
            modelBuilder.Entity("Picktime.Entities.Provider", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = 1,
                            CreatedBy = "Seed",
                            CreationDate = new DateTime(2025, 6, 20, 16, 6, 52, 129, DateTimeKind.Utc).AddTicks(2479),
            ...
            modelBuilder.Entity("Picktime.Entities.ProviderService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Seed",
                            CreationDate = new DateTime(2025, 6, 20, 16, 6, 52, 129, DateTimeKind.Utc).AddTicks(2496),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Seed",
                            CreationDate = new DateTime(2025, 6, 20, 16, 6, 52, 129, DateTimeKind.Utc).AddTicks(2501),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Seed",
                            CreationDate = new DateTime(2025, 6, 20, 16, 6, 52, 129, DateTimeKind.Utc).AddTicks(2503),
                            Description = "Service Time 1m ",
                            ExpectedEstimatedTime = new TimeOnly(0, 1, 0),
                            IsActive = true,
                            Name = "1m Service",
                        ...
                        new
                        {
                            ...
                            ActualEstimatedTime = new TimeOnly(0, 1, 30),
                            CreatedBy = "Seed",
                            CreationDate = new DateTime(2025, 6, 20, 16, 6, 52, 129, DateTimeKind.Utc).AddTicks(2505),
                            Description = "Service Time 2m ",
                            ExpectedEstimatedTime = new TimeOnly(0, 2, 0),
                            IsActive = true,
                            Name = "2m Service",
                        ...
                        new
                        {
                            ...
                            ActualEstimatedTime = new TimeOnly(0, 1, 0),
                            CreatedBy = "Seed",
                            CreationDate = new DateTime(2025, 6, 20, 16, 6, 52, 129, DateTimeKind.Utc).AddTicks(2507),
                            Description = "Service Time 2m ",
                            ExpectedEstimatedTime = new TimeOnly(0, 2, 0),
                            IsActive = true,
                            Name = "2m Service",
                        ...
                        new
                        {
                            ...
                            ActualEstimatedTime = new TimeOnly(0, 1, 0),
                            CreatedBy = "Seed",
                            CreationDate = new DateTime(2025, 6, 20, 16, 6, 52, 129, DateTimeKind.Utc).AddTicks(2509),
                            Description = "Service Time 2m ",
                            ExpectedEstimatedTime = new TimeOnly(0, 2, 0),
                            IsActive = true,
                            Name = "2m Service",
                        ...
                        new
                        {
                            ...
                            ActualEstimatedTime = new TimeOnly(0, 1, 0),
                            CreatedBy = "Seed",
                            CreationDate = new DateTime(2025, 6, 20, 16, 6, 52, 129, DateTimeKind.Utc).AddTicks(2510),
                            Description = "Service Time 2m ",
                            ExpectedEstimatedTime = new TimeOnly(0, 2, 0),
                            IsActive = true,
                            Name = "2m Service",
                        ...
                        new
                        {
                            ...
                            ActualEstimatedTime = new TimeOnly(0, 1, 0),
                            CreatedBy = "Seed",
                            CreationDate = new DateTime(2025, 6, 20, 16, 6, 52, 129, DateTimeKind.Utc).AddTicks(2512),
                            Description = "Service Time 2m ",
                            ExpectedEstimatedTime = new TimeOnly(0, 2, 0),
                            IsActive = true,
                            Name = "2m Service",
